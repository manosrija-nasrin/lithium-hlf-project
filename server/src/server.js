...
app.post('/doctor/sendMOCapproval',authenticateJWT, doctorRoutes.sendMOCapproval);
...
app.get('/technician/checkbloodavailability',authenticateJWT, technicianRoutes.checkBloodAvailability);
app.post('/technician/bloodallocation',authenticateJWT, technicianRoutes.allocateBag);
app.post('/technician/crossmatchblood',authenticateJWT, technicianRoutes.crossMatchResults);
app.post('/technician/finalDispatch',authenticateJWT, technicianRoutes.confirmbloodReceival);
app.post('/technician/readreceiverbloodbag',authenticateJWT, technicianRoutes.readReceiverBloodBag);
app.post('/technician/bloodrequest',authenticateJWT,technicianRoutes.bloodRequest);
app.post('/technician/readallocatedbloodbag',authenticateJWT, technicianRoutes.readAllocatedBloodBag);
app.get('/technician/LTapproval',authenticateJWT, technicianRoutes.LTapproval);
app.post('/technician/sendLTapproval',authenticateJWT, technicianRoutes.sendLTapproval);
