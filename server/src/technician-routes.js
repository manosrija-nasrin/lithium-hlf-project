...
exports.crossMatchResults = async (req, res) => {
    ...
    await validateRole([ROLE_TECHNICIAN], userRole, res);
    let args = req.body;
    let hospName=args.technicianId.startsWith("HOSP1")?"hospital 1":(args.technicianId.startsWith("HOSP2")?"hospital 2":"hospital 3");
    let r1=await databaseRoutes.bagInfo(args.bloodBagUnitNo,args.bloodBagSegmentNo,hospName);
    console.log(r1);
    r1=r1.data;
