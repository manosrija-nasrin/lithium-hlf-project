...
PEER0_HOSP3_CA=${DIR}/first-network/organizations/peerOrganizations/hosp3.lithium.com/tlsca/tlsca.hosp3.lithium.com-cert.pem
...
echo "PEER0_HOSP3_CA=${PEER0_HOSP3_CA}"
