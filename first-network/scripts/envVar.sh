...
# where execution occurs from folders outside of default as $PWD, such as the first-network/addHosp3 folder.
...
export PEER0_HOSP3_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/hosp3.lithium.com/tlsca/tlsca.hosp3.lithium.com-cert.pem
...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/hosp3.lithium.com/users/Admin@hosp3.lithium.com/msp
