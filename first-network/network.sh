...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    orderer_cert orderer orderer.lithium.com
    orderer_cert admin Admin@lithium.com
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.lithium.com docker_peer0.hosp1.lithium.com docker_peer0.hosp2.lithium.com
